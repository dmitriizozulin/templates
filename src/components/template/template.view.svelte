...
>
    ...
    <div class="btn_wrapper">
        <button class="btn" on:click={() => remove(template.id)}>Удалить</button>
    </div>
...
<style>
   ...
   .btn {
    ...
    background: linear-gradient(90deg, rgba(35,12,52,1) 0%, rgba(20,13,25,1) 24%, rgba(20,13,25,1) 76%, rgba(35,12,52,1) 100%);
    color: #fff;
